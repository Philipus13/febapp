...
public class EventAdapter extends BaseAdapter implements Filterable {
    ...
    int checked = 0;
    int check = 0;
    TextView textViewJudul,textStart,textEnd,textViewLokasi ;
    public static ArrayList<Boolean> itemChecked1 = null;


    //List of eventes

    public EventAdapter(Activity activity, List<Event> eventes) {
...
//        }
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        textViewLokasi = (TextView) convertView.findViewById(R.id.textViewLokasi);
...
//                .into(imageView);
        ...
        textViewLokasi.setText(event.getLokasi());
