...
/**
 * Created by Philipus on 25/05/2016.
 */
public class EventPopularFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
...
//    }
    ...
    private void callEvent(int page){
        ...
        String DATA_URL_POPULAR;
        if (group == 4) {
            DATA_URL_POPULAR = AppConfig.url+"/evenPopular/";
        }else if(group == 2){
            DATA_URL_POPULAR = AppConfig.url+"/evenPopularP3/";
        }else{
            DATA_URL_POPULAR = AppConfig.url+"/evenPopular/";
        }

        // Creating volley request obj
        JsonArrayRequest arrReq = new JsonArrayRequest( DATA_URL_POPULAR + page,
