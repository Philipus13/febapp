 ...
 */
public class EventNewFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
...
//    }
    ...
    private void callEvent(int page){
        ...
        String DATA_URL_NEW;
        if (group == 4) {
            DATA_URL_NEW = AppConfig.url+"/evenNew/";
        }else if(group == 2){
            DATA_URL_NEW = AppConfig.url+"/evenNewP3/";
        }else{
            DATA_URL_NEW = AppConfig.url+"/evenNew/";
        }

        // Creating volley request obj
        JsonArrayRequest arrReq = new JsonArrayRequest( DATA_URL_NEW + page,
